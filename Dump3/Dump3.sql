...
CREATE TABLE `flight` (
  ...
  `duration` bigint(20) NOT NULL COMMENT 'длительность полета в минутах',
...
CREATE TABLE `spr_place` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_uniq1` (`row`,`seat`,`flight_class_id`),
...
-- Dump completed on 2014-01-05 22:42:04
